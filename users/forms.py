...
class RegisterForm(UserCreationForm):
    ...
    password2 = forms.CharField(max_length=50,required=True, widget=forms.PasswordInput(attrs={'placeholder': 'Confirme su contraseña','class': 'form-control','data-toggle': 'password','id': 'password', }))
